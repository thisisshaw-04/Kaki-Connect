...
The UI uses a fixed four-colour system: **beige**, **lilac**, **crimson**, and **green**, with large type and a bottom tab bar that stays in the page flow so it never covers names, cards, or check-ins. Product copy, names, and tap paths are unchanged.
