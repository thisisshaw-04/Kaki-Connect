...
The UI uses a fixed four-colour system: **lilac** for outlines and buttons, **beige** for quiet paper surfaces, **green** for outdoor and “all good”, and **crimson** for SOS. Ink stays on the type. Cute round-head sticker illustrations sit on the main cards (outing walk, kopi chat, fishing, volunteer wave). Large type and a bottom tab bar stay in the page flow so they never cover names, cards, or check-ins. Product copy, names, and tap paths are unchanged.
